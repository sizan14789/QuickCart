...
import { productsListInterface } from "@/types/Interfaces";
...
const ProductsList = () => {
  const [productsList, setProductsList] = useState<productsListInterface[]>();
  ...
  if (!productsList) {
    ...
    return (
      <div className=" border-gray-300 border-1 rounded-md text-gray-700 border-b-0">
        ...
        {productsList.map((curElem: productsListInterface) => {
