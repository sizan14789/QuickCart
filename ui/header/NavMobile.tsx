...
const NavMobile = ({handleNavToggle}: {handleNavToggle:any}) => {
  ...
  return (
    <div className="flex gap-8 items-center pt-40 sm:pt-60 flex-col z-20 bg-white w-48 sm:w-80 h-svh relative">
      <button className="hover:bg-orange-600 duration-150 cursor-pointer hover:text-white rounded-full p-3" onClick={handleNavToggle} >
      ...
      <Link
        href="checkout"
        className={isActive("/checkout") ? "text-orange-600" : ""}
      >
        Checkout
      </Link>
      <Link
